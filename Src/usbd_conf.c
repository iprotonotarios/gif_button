...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE BEGIN USB_OTG_FS_MspDeInit 1 */
    ...
    GPIO_InitStructure.Pin = GPIO_PIN_9|GPIO_PIN_11|GPIO_PIN_12;
    GPIO_InitStructure.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStructure.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStructure);

//    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9|GPIO_PIN_11|GPIO_PIN_12, GPIO_PIN_SET);
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
  ...
  /* USER CODE BEGIN 4 */
  log_segger("usb connect\n");
  // TODO during this time, no sd operation should take place
  /* USER CODE END 4 */
}
