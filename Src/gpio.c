...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, D_RESET_Pin|D_DC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SW_3V3_CTL_GPIO_Port, SW_3V3_CTL_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, UI_LED_Pin|D_BCKL_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = D_RESET_Pin|D_DC_Pin|SW_3V3_CTL_Pin;
  ...
  GPIO_InitStruct.Pin = UI_LED_Pin|D_BCKL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
